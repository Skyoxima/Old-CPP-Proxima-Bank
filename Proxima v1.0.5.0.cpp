...
{
  if (strcmp("347657",accno)==0)
    {
     copy_cat();
     generate_run();
    }
  else if(strcmp("040203",accno)==0)
   {
     copy_cat();
     generate_run();
   }
  else if(strcmp("231009",accno)==0)
   {
     copy_cat();
     generate_run();
   }
  else if(strcmp("230475",accno)==0)
   {
     copy_cat();
     generate_run();
   }
  else if(strcmp("100971",accno)==0)
   {
     copy_cat();
     generate_run();
   }
  ...
  {
    cout<<"Entered account number was not found in database.\nWould you like to try again? : ";
    cin>>againno;
    if(againno==1)
    {
      getaccno();
    ...
    {
      cout<<"No transaction will be carried out now...exiting";
      delay(2000);
      exit(0);
    }
  }
