...
accnos.close();
cout<<"The entered account number is not recorded in our database...\n";
asknewaccount();
}
...
void rules()
{
 ...
 textcolor(15);                        //never remove this
  cprintf("1. When prompted, please press 1 for DEPOSITION or 2 for WITHDRAWAL."); cout<<endl;
  cprintf("2. When prompted for confirmation, please press 0 for NO or 1 for YES."); cout<<endl;
  cprintf("3. When prompted for a new transaction, press 1 for YES, 0 for NO."); cout<<endl;
  cprintf("4. When prompted for transaction history, press 1 for YES, 0 for NO."); cout<<endl;
  cprintf("5. When prompted for amount, do not put negative values!"); cout<<endl;
  cprintf("6. Incorrect selections for the above will terminate the transaction."); cout<<endl;
